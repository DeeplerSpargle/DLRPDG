...
!function () {
    function a(a, b) {
        ...
        c.chartRegistry = function () {
            ...
            return {
                has: function (a) {
                    ...
                    d = a(d);
                    for (var e = 0; e < b[d].length; e++)if (b[d][e].anchorName() === c.anchorName()) {
                        b[d].splice(e, 1);
                        break
                    }
                }, clear: function (a) {
        ...
        return c.utils.uniqueId = function () {
            ...
            var e = !1;
            return d
        }, c.events = {current: null}, c.events.trigger = function (a, b) {
            ...
            if (null === a)return null;
            var b, c = a;
            return b = c[0]instanceof Array ? [[Math.min(a[0][0], a[1][0]), Math.min(a[0][1], a[1][1])], [Math.max(a[0][0], a[1][0]), Math.max(a[0][1], a[1][1])]] : [[a[0], -(1 / 0)], [a[1], 1 / 0]], c.isFiltered = function (a) {
                var c, d;
            ...
            function g() {
                if (d.dimension() && d.dimension().filter) {
                    var a = I(d.dimension(), H);
                    H = a ? a : H
                }
            }

            d.__dcFlag__ = c.utils.uniqueId();
            var h, i, j, k, l, m, n, o, p = 200, q = function (a) {
                var b = a && a.getBoundingClientRect && a.getBoundingClientRect().width;
                return b && b > p ? b : p
            }, r = q, s = 200, t = function (a) {
                var b = a && a.getBoundingClientRect && a.getBoundingClientRect().height;
                return b && b > s ? b : s
            }, u = t, v = c.pluck("key"), w = c.pluck("value"), x = c.pluck("key"), y = c.pluck("key"), z = !1, A = function (a) {
                return d.keyAccessor()(a) + ": " + d.valueAccessor()(a)
            }, B = !0, C = 750, D = c.printers.filters, E = ["dimension", "group"], F = c.constants.DEFAULT_CHART_GROUP, G = a.dispatch("preRender", "postRender", "preRedraw", "postRedraw", "filtered", "zoomed", "renderlet", "pretransition"), H = [], I = function (a, b) {
            ...
            d.width = function (b) {
                return arguments.length ? (r = a.functor(b || q), d) : r(k.node())
            }, d.height = function (b) {
                return arguments.length ? (u = a.functor(b || t), d) : u(k.node())
                ...
                return arguments.length ? (J = a.functor(b), d.expireCache(), d) : J.call(d, i)
            }, d.group = function (a, b) {
                return arguments.length ? (i = a, d._groupName = b, d.expireCache(), d) : i
            }, d.ordering = function (a) {
                return arguments.length ? (y = a, n = b.quicksort.by(y), d.expireCache(), d) : y
            }, d._computeOrderedGroups = function (a) {
                var c = a.slice(0);
                return c.length <= 1 ? c : (n || (n = b.quicksort.by(y)), n(c, 0, c.length))
                ...
                return arguments.length ? (c.instanceOfChart(b) ? (j = b.anchor(), k = b.root(), m = !0) : (j = b, k = a.select(j), k.classed(c.constants.CHART_CLASS, !0), c.registerChart(d, e), m = !1), F = e, d) : j
                ...
                return k && (d.selectAll(".reset").style("display", null), d.selectAll(".filter").text(D(d.filters())).style("display", null)), d
                ...
                G.preRender(d), E && E.forEach(f);
                var a = d._doRender();
                return o && o.render(), d._activateRenderlets("postRender"), a
            }, d._activateRenderlets = function (a) {
                G.pretransition(d), d.transitionDuration() > 0 && l ? l.transition().duration(d.transitionDuration()).each("end", function () {
                    G.renderlet(d), a && G[a](d)
                }) : (G.renderlet(d), a && G[a](d))
            }, d.redraw = function () {
                G.preRedraw(d);
                var a = d._doRedraw();
                return o && o.render(), d._activateRenderlets("postRedraw"), a
            ...
            var L = function (a, b) {
                for (var c = 0; c < a.length; c++)if (a[c] <= b && a[c] >= b) {
                    a.splice(c, 1);
                    break
                }
                return a
            ...
            return d.resetFilterHandler = function (a) {
                ...
                return arguments.length ? (a instanceof Array && a[0]instanceof Array && !a.isFiltered ? a[0].forEach(function (a) {
                    d.hasFilter(a) ? L(H, a) : M(H, a)
                }) : null === a ? H = N(H) : d.hasFilter(a) ? L(H, a) : M(H, a), g(), d._invokeFilteredListener(a), null !== k && d.hasFilter() ? d.turnOnControls() : d.turnOffControls(), d) : H.length > 0 ? H[0] : null
            }, d.filters = function () {
                return H
                ...
                return []
            }, d.legendHighlight = function () {
            }, d.legendReset = function () {
            }, d.legendToggle = function () {
            }, d.isLegendableHidden = function () {
                return !1
                ...
                return arguments.length ? (x = a, z = !0, d) : x
                ...
                return arguments.length ? (m || c.deregisterChart(d, F), F = a, m || c.registerChart(d, F), d) : F
            }, d.expireCache = function () {
                return d
            }, d.legend = function (a) {
                return arguments.length ? (o = a, o.parent(d), d) : o
            }, d.chartID = function () {
                return d.__dcFlag__
            }, d.options = function (a) {
                var b = ["anchor", "group", "xAxisLabel", "yAxisLabel", "stack", "title", "point", "getColor", "overlayGeoJson"];
                for (var e in a)"function" == typeof d[e] ? a[e]instanceof Array && -1 !== b.indexOf(e) ? d[e].apply(d, a[e]) : d[e].call(d, a[e]) : c.logger.debug("Not a valid option setter name: " + e);
                return d
            }, d.on = function (a, b) {
                return G.on(a, b), d
            }, d
            ...
            var c = a.scale.category20c(), d = !0, e = function (a) {
            ...
            function d() {
                V = !0, Y && (b.x().domain(m(b.x().domain(), z)), G && b.x().domain(m(b.x().domain(), G.x().domain())));
                var a = b.x().domain(), d = c.filters.RangedFilter(a[0], a[1]);
                b.replaceFilter(d), b.rescale(), b.redraw(), G && !n(b.filter(), G.filter()) && c.events.trigger(function () {
                    G.replaceFilter(d), G.redraw()
                }), b._invokeZoomedListener(), c.events.trigger(function () {
                    b.redrawGroup()
                }, c.constants.EVENT_DELAY), V = !n(a, z)
            }
            ...
            function f(a, c) {
                b.isOrdinal() ? (b.elasticX() || 0 === y.domain().length) && y.domain(b._ordinalXDomain()) : b.elasticX() && y.domain([b.xAxisMin(), b.xAxisMax()]);
                var d = y.domain();
                (c || e(B, d)) && b.rescale(), B = d, b.isOrdinal() ? y.rangeBands([0, b.xAxisLength()], da, b._useOuterPadding() ? ca : 0) : y.range([0, b.xAxisLength()]), I = I.scale(b.x()), g(a)
            }

            function g(a) {
                var d = a.selectAll("g." + r);
                if (U) {
                    d.empty() && (d = a.insert("g", ":first-child").attr("class", p + " " + r).attr("transform", "translate(" + b.margins().left + "," + b.margins().top + ")"));
                    var e = I.tickValues() ? I.tickValues() : "function" == typeof y.ticks ? y.ticks(I.ticks()[0]) : y.domain(), f = d.selectAll("line").data(e), g = f.enter().append("line").attr("x1", function (a) {
                        return y(a)
            ...
            function j() {
                var a = c.utils.appendOrSelect(v, "defs"), d = i(), e = c.utils.appendOrSelect(a, "#" + d, "clipPath").attr("id", d), f = 2 * ba;
                c.utils.appendOrSelect(e, "rect").attr("width", b.xAxisLength() + f).attr("height", b.yAxisHeight() + f).attr("transform", "translate(-" + ba + ", -" + ba + ")")
            }

            function k(a) {
                b.isOrdinal() && (S = !1), f(b.g(), a), b._prepareYAxis(b.g()), b.plotData(), (b.elasticX() || W || a) && b.renderXAxis(b.g()), (b.elasticY() || W || a) && b.renderYAxis(b.g()), a ? b.renderBrush(b.g()) : b.redrawBrush(b.g()), W = !1
            }

            function l() {
                aa ? b._enableMouseZoom() : _ && b._disableMouseZoom()
            }
            ...
            var p = "grid-line", q = "horizontal", r = "vertical", s = "y-axis-label", t = "x-axis-label", u = 12;
            b = c.colorMixin(c.marginMixin(c.baseMixin(b))), b.colors(a.scale.category10()), b._mandatoryAttributes().push("x");
            var v, w, x, y, z, A, B, C, D, E, F, G, H, I = a.svg.axis().orient("bottom"), J = c.units.integers, K = 0, L = !1, M = 0, N = a.svg.axis().orient("left"), O = 0, P = !1, Q = 0, R = a.svg.brush(), S = !0, T = !1, U = !1, V = !1, W = !1, X = [1, 1 / 0], Y = !0, Z = a.behavior.zoom().on("zoom", d), $ = a.behavior.zoom().on("zoom", null), _ = !1, aa = !1, ba = 0, ca = .5, da = 0, ea = !1;
            return b.rescale = function () {
                F = void 0, W = !0
            }, b.rangeChart = function (a) {
                return arguments.length ? (G = a, G.focusChart(b), b) : G
            }, b.zoomScale = function (a) {
                return arguments.length ? (X = a, b) : X
            }, b.zoomOutRestrict = function (a) {
                return arguments.length ? (X[0] = a ? 1 : 0, Y = a, b) : Y
            }, b._generateG = function (a) {
                return v = void 0 === a ? b.svg() : a, w = v.append("g"), x = w.append("g").attr("class", "chart-body").attr("transform", "translate(" + b.margins().left + ", " + b.margins().top + ")").attr("clip-path", "url(#" + i() + ")"), w
            }, b.g = function (a) {
                return arguments.length ? (w = a, b) : w
            }, b.mouseZoomable = function (a) {
                return arguments.length ? (aa = a, b) : aa
            }, b.chartBodyG = function (a) {
                return arguments.length ? (x = a, b) : x
            }, b.x = function (a) {
                return arguments.length ? (y = a, z = y.domain(), b.rescale(), b) : y
                ...
                if (void 0 === F) {
                    ...
                    F = a instanceof Array ? a.length : a
                }
                return F
                ...
                var e = a.selectAll("text." + t);
                e.empty() && b.xAxisLabel() && (e = a.append("text").attr("transform", "translate(" + (b.margins().left + b.xAxisLength() / 2) + "," + (b.height() - M) + ")").attr("class", t).attr("text-anchor", "middle").text(b.xAxisLabel())), b.xAxisLabel() && e.text() !== b.xAxisLabel() && e.text(b.xAxisLabel()), c.transition(d, b.transitionDuration()).call(I)
            }, b._xAxisY = function () {
                return b.height() - b.margins().bottom
            }, b.xAxisLength = function () {
                return b.effectiveWidth()
            }, b.xAxisLabel = function (a, c) {
                return arguments.length ? (A = a, b.margins().bottom -= M, M = void 0 === c ? u : c, b.margins().bottom += M, b) : A
            }, b._prepareYAxis = function (c) {
                if (void 0 === C || b.elasticY()) {
                    C = a.scale.linear();
                    var d = b.yAxisMin() || 0, e = b.yAxisMax() || 0;
                    C.domain([d, e]).rangeRound([b.yAxisHeight(), 0])
                }
                C.range([b.yAxisHeight(), 0]), N = N.scale(C), ea && N.orient("right"), b._renderHorizontalGridLinesForAxis(c, C, N)
            }, b.renderYAxisLabel = function (a, c, d, e) {
                e = e || Q;
                var f = b.g().selectAll("text." + s + "." + a + "-label");
                if (f.empty() && c) {
                    var g = b.margins().top + b.yAxisHeight() / 2;
                    f = b.g().append("text").attr("transform", "translate(" + e + "," + g + "),rotate(" + d + ")").attr("class", s + " " + a + "-label").attr("text-anchor", "middle").text(c)
                }
                c && f.text() !== c && f.text(c)
                ...
                var a = ea ? b.width() - b.margins().right : b._yAxisX();
                b.renderYAxisAt("y", N, a);
                var c = ea ? b.width() - Q : Q, d = ea ? 90 : -90;
                b.renderYAxisLabel("y", b.yAxisLabel(), d, c)
            }, b._renderHorizontalGridLinesForAxis = function (a, d, e) {
                var f = a.selectAll("g." + q);
                if (T) {
                    var g = e.tickValues() ? e.tickValues() : d.ticks(e.ticks()[0]);
                    f.empty() && (f = a.insert("g", ":first-child").attr("class", p + " " + q).attr("transform", "translate(" + b.margins().left + "," + b.margins().top + ")"));
                    var h = f.selectAll("line").data(g), i = h.enter().append("line").attr("x1", 1).attr("y1", function (a) {
                        return d(a)
                ...
                return arguments.length ? (D = a, b.margins().left -= Q, Q = void 0 === c ? u : c, b.margins().left += Q, b) : D
            }, b.y = function (a) {
                return arguments.length ? (C = a, b.rescale(), b) : C
            }, b.yAxis = function (a) {
                ...
                return c.utils.subtract(d, K)
            }, b.xAxisMax = function () {
                var d = a.max(b.data(), function (a) {
                    return b.keyAccessor()(a)
                });
                return c.utils.add(d, K)
            }, b.yAxisMin = function () {
                var d = a.min(b.data(), function (a) {
                    return b.valueAccessor()(a)
                });
                return c.utils.subtract(d, O)
            }, b.yAxisMax = function () {
                var d = a.max(b.data(), function (a) {
                    return b.valueAccessor()(a)
                });
                return c.utils.add(d, O)
                ...
                if (S) {
                    R.on("brush", b._brushing), R.on("brushstart", b._disableMouseZoom), R.on("brushend", l);
                    var c = a.append("g").attr("class", "brush").attr("transform", "translate(" + b.margins().left + "," + b.margins().top + ")").call(R.x(b.x()));
                ...
                a.selectAll("rect").attr("height", h())
            }, b.extendBrush = function () {
                var a = R.extent();
                return b.round() && (a[0] = a.map(b.round())[0], a[1] = a.map(b.round())[1], w.select(".brush").call(R.extent(a))), a
            }, b.brushIsEmpty = function (a) {
                return R.empty() || !a || a[1] <= a[0]
            }, b._brushing = function () {
                var a = b.extendBrush();
                if (b.redrawBrush(w), b.brushIsEmpty(a))c.events.trigger(function () {
                    b.filter(null), b.redrawGroup()
                }, c.constants.EVENT_DELAY); else {
                ...
                return arguments.length ? (ba = a, b) : ba
            }, b._preprocessData = function () {
            }, b._doRender = function () {
                return b.resetSvg(), b._preprocessData(), b._generateG(), j(), k(!0), l(), b
            }, b._doRedraw = function () {
                return b._preprocessData(), k(!1), j(), b
            }, b._enableMouseZoom = function () {
                _ = !0, Z.x(b.x()).scaleExtent(X).size([b.width(), b.height()]).duration(b.transitionDuration()), b.root().call(Z)
            }, b._disableMouseZoom = function () {
                b.root().call($)
            }, b.focus = function (a) {
                b.x().domain(o(a) ? a : z), Z.x(b.x()), d()
            }, b.refocused = function () {
                return V
            }, b.focusChart = function (a) {
                return arguments.length ? (H = a, b.on("filtered", function (a) {
                    a.filter() ? n(a.filter(), H.filter()) || c.events.trigger(function () {
                        H.focus(a.filter())
                    }) : c.events.trigger(function () {
                        H.x().domain(H.xOriginalDomain())
                    })
                }), b) : H
            ...
            var i = a.layout.stack().values(d), j = [], k = {}, l = !1;
            return b.stack = function (a, c, d) {
                ...
                var a = g().map(c.pluck("data")), d = b._computeOrderedGroups(a);
                ...
                return j.map(function (a, c) {
                    return {chart: b, name: a.name, hidden: a.hidden || !1, color: b.getColor.call(a, a.values, c)}
                })
            ...
            var d = 1 / 0, e = "Others", f = function (c) {
                var d = a.sum(c, b.valueAccessor()), f = b.group().all(), g = a.sum(f, b.valueAccessor()), h = c.map(b.keyAccessor()), i = f.map(b.keyAccessor()), j = a.set(h), k = i.filter(function (a) {
                    return !j.has(a)
                });
                return g > d ? c.concat([{others: k, key: e, value: g - d}]) : c
            };
            ...
            var f = a.scale.linear().domain([0, 100]), g = function (a) {
                return a.r
            };
            b.r = function (a) {
                return arguments.length ? (f = a, b) : f
            ...
            function w(b) {
                b.innerRadius = M;
                var c = this._current;
                x(c) && (c = {startAngle: 0, endAngle: 0});
                var d = a.interpolate(c, b);
                return this._current = d(0), function (a) {
                    return A(d(a), 0, r())
                }
            }
            ...
            var D, E, F, G, H, I = .5, J = "pie-slice", K = "empty-chart", L = "empty", M = 0, N = I, O = c.capMixin(c.colorMixin(c.baseMixin({})));
            return O.colorAccessor(O.cappedKeyAccessor), O.title(function (a) {
                ...
                return O.data().map(function (a, b) {
                    var c = {name: a.key, data: a.value, others: a.others, chart: O};
                ...
                O.onClick({key: a.name, others: a.others})
            }, O.anchor(b, d)
            ...
            function f(a, b, d) {
                var f = a.selectAll("rect.bar").data(d.values, c.pluck("x")), g = f.enter().append("rect").attr("class", "bar").attr("fill", c.pluck("data", l.getColor)).attr("y", l.yAxisHeight()).attr("height", 0);
            ...
            function g() {
                if (void 0 === i) {
                    var a = l.xUnitCount();
                    i = Math.floor(l.isOrdinal() && void 0 === m ? l.x().rangeBand() : m ? (l.xAxisLength() - (a - 1) * m) / a : l.xAxisLength() / (1 + l.barPadding()) / a), (i === 1 / 0 || isNaN(i) || j > i) && (i = j)
                }
            }

            function h(b, c) {
                return function () {
                    var d = a.select(this), e = d.attr("fill") === b;
                    return c ? !e : e
                }
            }

            var i, j = 1, k = 2, l = c.stackMixin(c.coordinateGridMixin({})), m = k, n = !1, o = !1;
            return c.override(l, "rescale", function () {
                ...
                var a = l.chartBodyG().selectAll("rect.bar"), b = l.brush().extent();
                if (l.isOrdinal())l.hasFilter() ? (a.classed(c.constants.SELECTED_CLASS, function (a) {
                    ...
                    return !l.hasFilter(a.x)
                })) : (a.classed(c.constants.SELECTED_CLASS, !1), a.classed(c.constants.DESELECTED_CLASS, !1)); else if (l.brushIsEmpty(b))a.classed(c.constants.DESELECTED_CLASS, !1); else {
                    var d = b[0], e = b[1];
                    a.classed(c.constants.DESELECTED_CLASS, function (a) {
                        return a.x < d || a.x >= e
                    })
            ...
            function l(a, b) {
                var c = a.attr("cx"), d = a.attr("cy"), e = z._yAxisX() - z.margins().left, f = "M" + e + " " + d + "L" + c + " " + d, g = "M" + c + " " + z.yAxisHeight() + "L" + c + " " + d;
            ...
            function q(b, c, d) {
                return function () {
                    var e = a.select(this), f = e.attr("stroke") === b && e.attr("stroke-dasharray") === (c instanceof Array ? c.join(",") : null) || e.attr("fill") === b;
                    return d ? !f : f
                }
            }

            var r, s, t = 5, u = "dc-tooltip", v = "dot", w = "yRef", x = "xRef", y = 1e-6, z = c.stackMixin(c.coordinateGridMixin({})), A = !1, B = t, C = null, D = y, E = y, F = "linear", G = .7, H = !0;
            return z.transitionDuration(500), z._rangeBandPadding(1), z.plotData = function () {
                var a = z.chartBodyG(), b = a.selectAll("g.stack-list");
                b.empty() && (b = a.append("g").attr("class", "stack-list"));
                var c = b.selectAll("g.stack").data(z.data()), d = c.enter().append("g").attr("class", function (a, b) {
                    return "stack _" + b
                });
                f(d, c), g(d, c), i(a, c)
            ...
            var e = a.format(",d"), f = c.baseMixin({}), g = {some: "", all: ""};
            return f.html = function (a) {
                ...
                var a = f.dimension().size(), b = f.group().value(), c = e(a), d = e(b);
            ...
            function e() {
                ...
                if (o.forEach(function (b) {
                    ...
                    var b = m.root().selectAll("th").data(o), c = b.enter().append("th");
            ...
            var h = "dc-table-label", i = "dc-table-row", j = "dc-table-column", k = "dc-table-group", l = "dc-table-head", m = c.baseMixin({}), n = 25, o = [], p = function (a) {
                return a
            }, q = a.ascending;
            return m._doRender = function () {
                ...
                var b = String(a), c = b.indexOf("return ");
                if (c >= 0) {
                    var d = b.lastIndexOf(";");
                    if (d >= 0) {
                        b = b.substring(c + 7, d);
            ...
            var h = "dc-grid-label", i = "dc-grid-item", j = "dc-grid-group", k = "dc-grid-top", l = c.baseMixin({}), m = 999, n = function (a) {
                return "you need to provide an html() handling param:  " + JSON.stringify(a)
            }, o = function (a) {
                return a
            }, p = a.ascending, q = function (a) {
            ...
            var i = c.bubbleMixin(c.coordinateGridMixin({})), j = !1;
            ...
            var r, s = "sub", t = 12, u = c.coordinateGridMixin({}), v = [], w = {}, x = !1, y = !0, z = a.svg.axis(), A = 0, B = t, C = !1;
            return u._mandatoryAttributes([]), u.transitionDuration(500), c.override(u, "_generateG", function () {
                for (var a = this.__generateG(), b = 0; b < v.length; ++b) {
                    var c = v[b];
                    g(c, b), c.dimension() || c.dimension(u.dimension()), c.group() || c.group(u.group()), c.chartGroup(u.chartGroup()), c.svg(u.svg()), c.xUnits(u.xUnits()), c.transitionDuration(u.transitionDuration()), c.brushOn(u.brushOn()), c.renderTitle(u.renderTitle()), c.elasticX(u.elasticX())
                }
                return a
            ...
            var h, i = c.compositeChart(b, d), j = {}, k = c.lineChart, l = a.ascending, m = e;
            return i._mandatoryAttributes().push("seriesAccessor", "chart"), i.shareColors(!0), i._preprocessData = function () {
                var b, c = [], e = a.nest().key(h);
                l && e.sortKeys(l), m && e.sortValues(m);
                var g = e.entries(i.data()), n = g.map(function (e, f) {
                    var g = j[e.key] || k.call(i, i, d, e.key, f);
                    return j[e.key] || (b = !0), j[e.key] = g, c.push(e.key), g.dimension(i.dimension()).group({all: a.functor(e.values)}, e.key).keyAccessor(i.keyAccessor()).valueAccessor(i.valueAccessor()).brushOn(i.brushOn())
                });
            ...
            function h(a) {
                var b = p.svg().selectAll(i(a)).classed("selected", function (b) {
                    ...
                    var d = m(a).name, e = c.utils.nameToId(m(a).keyAccessor(b)), f = d + " " + e;
            ...
            return p._doRender = function () {
                ...
                for (var a = 0; a < s.length; ++a) {
                    var b = p.svg().append("g").attr("class", "layer" + a), c = b.selectAll("g." + m(a).name).data(m(a).data).enter().append("g").attr("class", m(a).name);
                ...
                for (var d = 0; d < s.length; ++d)if (s[d].name === b)return s[d].data = a, s[d].keyAccessor = c, p;
            ...
            function f() {
                ...
                o.forEach(function (b) {
                    var d = h(b, a), e = d.select("circle." + m);
            ...
            function h(a, b) {
                var d = l + " " + c.utils.nameToId(a.name), e = j.select("g." + c.utils.nameToId(a.name));
            ...
            var j, k = "bubble-overlay", l = "node", m = "bubble", n = c.bubbleMixin(c.baseMixin({})), o = [];
            return n.transitionDuration(750), n.radiusValueAccessor(function (a) {
                ...
                if (b) {
                    ...
                    d.append("rect").attr("width", n.width()).attr("height", n.height()).on("mousemove", function () {
                        var b = a.mouse(d.node()), c = b[0] + ", " + b[1];
                        e.text(c)
                    })
            ...
            function q(a) {
                var b = t(G.cappedValueAccessor(a)), c = k(), d = b > c ? c : b;
            ...
            var s, t, u, v, w = 10, x = 15, y = !1, z = "0.35em", A = 2, B = 5, C = !1, D = "row", E = "titlerow", F = !1, G = c.capMixin(c.marginMixin(c.colorMixin(c.baseMixin({})))), H = a.svg.axis().orient("bottom");
            ...
            var b, d, e = 2, f = {}, g = 0, h = 0, i = 12, j = 5, k = !1, l = 560, m = 70, n = !1;
            return f.parent = function (a) {
                ...
                var f = b.legendables(), o = d.selectAll("g.dc-legend-item").data(f).enter().append("g").attr("class", "dc-legend-item").on("mouseover", function (a) {
                    b.legendHighlight(a)
                ...
                o.attr("transform", function (b, c) {
                    if (k) {
                        var d = "translate(" + p + "," + q * a() + ")", e = n === !0 ? this.getBBox().width + j : m;
            ...
            var g = c.coordinateGridMixin({}), h = a.svg.symbol(), i = function (a) {
                return a.value
            }, j = g.keyAccessor();
            ...
            return h.size(function (a) {
                ...
                return [{chart: g, name: g._groupName, color: g.getColor()}]
            ...
            }, g.setHandlePaths = function () {
            }, g.extendBrush = function () {
            ...
            var e = "number-display", f = a.format(".2s"), g = c.baseMixin({}), h = {one: "", some: "", none: ""};
            return g._mandatoryAttributes(["group"]),
                ...
                c.empty() && (c = c.data([0]).enter().append("span").attr("class", e)), c.transition().duration(g.transitionDuration()).ease("quad-out-in").tween("text", function () {
                    ...
                    return this.lastValue = b, function (a) {
                        var d = null, e = g.formatNumber()(c(a));
            ...
            var f, g, h, i = 6.75, j = a.ascending, k = a.ascending, l = a.scale.ordinal(), m = a.scale.ordinal(), n = i, o = i, p = c.colorMixin(c.marginMixin(c.baseMixin({})));
            ...
            return c.override(p, "filter", function (a) {
                ...
                var a = p.data(), b = p.rows() || a.map(p.valueAccessor()), d = p.cols() || a.map(p.keyAccessor());
                k && (b = b.sort(k)), j && (d = d.sort(j)), b = m.domain(b), d = l.domain(d);
                var e = b.domain().length, g = d.domain().length, h = Math.floor(p.effectiveWidth() / g), i = Math.floor(p.effectiveHeight() / e);
            ...
            a.box = function () {
                function d(b) {
                    b.each(function (b, c) {
                        ...
                        var d = a.select(this), m = b.length, n = b[0], o = b[m - 1], p = b.quartiles = k(b), q = j && j.call(this, b, c), r = q && q.map(function (a) {
                                return b[a]
                            }), s = q ? a.range(0, q[0]).concat(a.range(q[1] + 1, m)) : a.range(m), t = a.scale.linear().domain(h && h.call(this, b, c) || [n, o]).range([f, 0]), u = this.__chart__ || a.scale.linear().domain([0, 1 / 0]).range(t.range());
                        this.__chart__ = t;
                        ...
                        var A = l || t.tickFormat(8), B = d.selectAll("text.box").data(p);
                ...
                var e = 1, f = 1, g = 0, h = null, i = Number, j = b, k = c, l = null;
            ...
            var i = c.coordinateGridMixin({}), j = 1.5, k = e, l = k(j), m = a.box(), n = null, o = function (a, b) {
    ...
    if ("function" == typeof define && define.amd)define(["d3", "crossfilter"], a); else if ("object" == typeof module && module.exports) {
        var b = require("d3"), c = require("crossfilter");
